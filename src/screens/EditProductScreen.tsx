    ...
    >
      <ScrollView style={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.form}>
          ...
          {imageUri && <Text style={styles.newImgNote}>✅ Đã chọn ảnh mới</Text>}

          <Text style={styles.label}>Tên sản phẩm *</Text>
          <TextInput style={styles.input} value={tensp} onChangeText={setTensp} />
          ...
          <TextInput style={styles.input} value={loaisp} onChangeText={setLoaisp} />
...
const styles = StyleSheet.create({
  ...
  form: { padding: 20 },
  idText: { fontSize: 12, color: '#95a5a6', marginBottom: 10, fontStyle: 'italic' },
  ...
  tagActive: { backgroundColor: '#e67e22', borderColor: '#e67e22' },
  tagText: { color: '#7f8c8d', fontSize: 13 },
  tagTextActive: { color: '#fff' },
  btn: {
    backgroundColor: '#e67e22', borderRadius: 12, padding: 16,
